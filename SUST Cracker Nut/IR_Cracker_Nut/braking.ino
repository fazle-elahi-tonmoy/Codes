...
a:
  ...
  while (1) {
    ...
    else if (temp == 3) p = map(analogRead(13), 0, 1000, 0, 150);
    else if (temp == 4) p = map(analogRead(13), 0, 1000, 150, 250);
    else if (temp == 5) p = map(analogRead(13), 0, 1000, 0, 150);
    else if (temp == 6) p = map(analogRead(13), 0, 1000, 1, 9);
    else if (temp == 7) p = map(analogRead(13), 0, 1000, 0, 250);
