...
const int button[9] = { lb, rb, l1, l2, r1, r2, e1, e2, calb };
const int pot[4] = { lx, ly, rx, ry};
int pot_val[6], pot_min[2] = { 0, 0 }, pot_max[2] = { 4095, 4095 };
int pot_mid[4] = { 2000, 1980, 1950, 1960 };
int button_val[6];
int temp[13] = { 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2 };


void setup() {
  for (byte i = 0; i < 9; i++) pinMode(button[i], INPUT_PULLUP);
  Serial.begin(115200);
}
