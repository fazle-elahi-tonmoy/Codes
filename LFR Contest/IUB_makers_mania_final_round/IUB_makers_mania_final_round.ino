...
void setup()
{
  ...
  if (digitalRead(8) == HIGH) counter = 1;
  if (digitalRead(9) == HIGH) counter = 2;
  if (digitalRead(10) == HIGH) counter = 3;
  if (digitalRead(11) == HIGH) counter = 4;
  if (digitalRead(12) == HIGH) counter = 5;
